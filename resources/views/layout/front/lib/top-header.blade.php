                        ...
                        <div id="top-links" class="nav pull-right">
                            <ul class="list-inline">
                                ...
                                <li><a href="#" id="wishlist-total" title="Wish List (0)"><i class="fa fa-heart"
                                                                                             aria-hidden="true"></i><span>Wish List</span><span> (0)</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="header-inner">
            <div class="col-sm-3 col-xs-3 header-left">
                <div id="logo"><a href="#"><img src="{{asset('asset/front/image/logo.png')}}" title="E-Commerce"
                                                alt="E-Commerce"
                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <td class="text-center"><a href="#"><img class="img-thumbnail"
                                                                             ...
                                                                             src="image/product/7product56x72.jpg"></a>
                                    </td>

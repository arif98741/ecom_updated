<footer>
    ...
    <div class="footer-bottom">
        <div id="bottom-footer">
            ...
            <div class="copyright"> Copyright - <a class="yourstore" href="#">
                    &copy; {{ date('Y') }} </a></div>
            <div class="footer-bottom-cms">
                <div class="footer-payment">
                    <ul>
                        <li class="mastero"><a href="#"><img alt=""
                                                             src="{{ asset('asset/front/image/payment/mastero.jpg')}}"></a>
                        </li>
                        <li class="visa"><a href="#"><img alt="" src="{{ asset('asset/front/image/payment/visa.jpg')}}"></a>
                        </li>
                        <li class="currus"><a href="#"><img alt=""
                                                            src="{{ asset('asset/front/image/payment/currus.jpg')}}"></a>
                        </li>
                        <li class="discover"><a href="#"><img alt=""
                                                              src="{{ asset('asset/front/image/payment/discover.jpg')}}"></a>
                        </li>
                    </ul>
                </div>
            </div>

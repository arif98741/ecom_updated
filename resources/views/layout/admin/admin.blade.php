...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{ asset('asset/admin/vendor/bootstrap/css/bootstrap.min.css')}}">
    <link href="{{ asset('asset/admin/vendor/fonts/circular-std/style.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('asset/admin/libs/css/style.css')}}">
    <link rel="stylesheet" href="{{ asset('asset/admin/vendor/fonts/fontawesome/css/fontawesome-all.css')}}">
    <link rel="stylesheet" href="{{ asset('asset/admin/vendor/charts/chartist-bundle/chartist.css')}}">
    <link rel="stylesheet" href="{{ asset('asset/admin/vendor/charts/morris-bundle/morris.css')}}">
    <link rel="stylesheet" href="{{ asset('asset/admin/vendor/fonts/material-design-iconic-font/css/materialdesignicons.min.css')}}">
    <link rel="stylesheet" href="{{ asset('asset/admin/vendor/charts/c3charts/c3.css')}}">
    <link rel="stylesheet" href="{{ asset('asset/admin/vendor/fonts/flag-icon-css/flag-icon.min.css')}}">
...
<div class="dashboard-main-wrapper">
    ...
    <!-- navbar -->
    <!-- ============================================================== -->
@include('layout.admin.lib.navbar')
<!-- ============================================================== -->
    <!-- end navbar -->
    <!-- ============================================================== -->
    <!-- ============================================================== -->
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <td>1</td>
                                                <td>
                                                    <div class="m-r-10"><img src="{{ asset('asset/admin/images/product-pic.jpg')}}"
                                            ...
                                            <tr>
                                                <td>2</td>
                                                <td>
                                                    <div class="m-r-10"><img src="{{ asset('asset/admin/images/product-pic-2.jpg')}}"
                                                                             alt="user" class="rounded" width="45">
                                                    </div>
                                                </td>
                                                <td>Product #2</td>
                                            ...
                                            <tr>
                                                <td>3</td>
                                                <td>
                                                    <div class="m-r-10"><img src="{{ asset('asset/admin/images/product-pic-3.jpg')}}"
                                                                             alt="user" class="rounded" width="45">
                                                    </div>
                                                </td>
                                                <td>Product #3</td>
                                            ...
                                            <tr>
                                                <td>4</td>
                                                <td>
                                                    <div class="m-r-10"><img src="{{ asset('asset/admin/images/product-pic-4.jpg')}}"
                                                                             alt="user" class="rounded" width="45">
                                                    </div>
                                                </td>
                                                <td>Product #4</td>
...
<!-- Optional JavaScript -->
<!-- jquery 3.3.1 -->
<script src="{{ asset('asset/admin/vendor/jquery/jquery-3.3.1.min.js')}}"></script>
<!-- bootstap bundle js -->
<script src="{{ asset('asset/admin/vendor/bootstrap/js/bootstrap.bundle.js')}}"></script>
<!-- slimscroll js -->
<script src="{{ asset('asset/admin/vendor/slimscroll/jquery.slimscroll.js')}}"></script>
<!-- main js -->
<script src="{{ asset('asset/admin/libs/js/main-js.js')}}"></script>
<!-- chart chartist js -->
<script src="{{ asset('asset/admin/vendor/charts/chartist-bundle/chartist.min.js')}}"></script>
<!-- sparkline js -->
<script src="{{ asset('asset/admin/vendor/charts/sparkline/jquery.sparkline.js')}}"></script>
<!-- morris js -->
<script src="{{ asset('asset/admin/vendor/charts/morris-bundle/raphael.min.js')}}"></script>
<script src="{{ asset('asset/admin/vendor/charts/morris-bundle/morris.js')}}"></script>
<!-- chart c3 js -->
<script src="{{ asset('asset/admin/vendor/charts/c3charts/c3.min.js')}}"></script>
<script src="{{ asset('asset/admin/vendor/charts/c3charts/d3-5.4.0.min.js')}}"></script>
<script src="{{ asset('asset/admin/vendor/charts/c3charts/C3chartjs.js')}}"></script>
<script src="{{ asset('asset/admin/libs/js/dashboard-ecommerce.js')}}"></script>
</body>
